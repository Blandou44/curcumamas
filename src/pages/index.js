...
const IndexPage = () => {
  return (
    <main>
      ...
      />
      <h2>Traiteur du post-partum* à Toulouse</h2>
      <p>
        * Le post partum est par définition d’une durée de 40 jours après la
        naissance. Chez les curcumamas on pense que c’est à vous de ressentir la
        durée, nous prendrons soin de vous tant que vous le souhaitez.
      </p>
      <h2>QUE MIJOTENT LES CURCUMAMAS ?</h2>
      <h3>Formules & Cartes Cadeaux</h3>
      <ul>
        <li>
          <p>
        ...
        <li>
          <p>
            Deux options sont possibles : végé ou flexi (Pour l'option flexi : 2
            repas sur trois comprennent de la viande) Livraisons sur Toulouse et
            sa périphérie proche tous les mardis (fourchette horaire précisée la
            veille). Nous livrons plus loin en Haute-Garonne en appliquant un
            supplément de livraison calculé avec vous.
          </p>
        </li>
        <li>
          <p>
            Fin de prise des commandes : vendredi 14h (de la semaine précédant
            votre livraison). Toute autre demande sera, bien sûr, discutée avec
            vous pour trouver ensemble la solution qui vous convient
          </p>
        </li>
        <li>
          <p>
            Tout est bio, à 80% local et ayurvédique, nos plats sont à consommer
            sous 3 jours après la livraison
          </p>
        </li>
      </ul>
      <FormulesContainer>
        ...
        <Card>
          ...
          <p>
            ...
            reste une double ration de plaisir ET de temps libre. À partager ou
            non. Grâce à la formule duo, doublez les quantités de la formule 3
            jours et libérez vous de 6 repas.
          </p>
          <Button>Réserver</Button>
        </Card>
        <Card>
      ...
      <PetitPlusContainer>
        ...
        <PetitsPlus>
          ...
          <p>
            ...
            coco chocolat. Dans un yaourt avec des fruits frais, et c’est parti
            !
          </p>
        </PetitsPlus>
        <PetitsPlus>
      ...
      <h3>En plus dans la curcumarmite</h3>
      <PlusContainer>
        <Card>
          <StaticImage
          ...
          <p>
            ...
            soutenir pendant ton post partum ? Elle sera ravie de t’accompagner,
            de te concocter de bons petits plats, te faire des massages pré et
            postnataux et bien d’autre. Écris-lui si tu as des questions.
          </p>
        ...
        <Card>
          ...
          />
          <h4>
            Consultation : alimentation et naturopathie de la femme enceinte et
            du postpartum
          </h4>
          <p>
            En quoi cela consiste ? Mener une consultation nutrition pour les
            futures mamans et accompagner au changement alimentaire. Conseiller
            une alimentation adaptée à chaque trimestre de la grossesse Prévenir
            et accompagner par des moyens naturels des maux qui gênent les
            futures mamans (au 3 ème trimestre notamment : transit lent, prise
            de poids, reflux, douleurs lombaires, sommeil difficile etc).
            Conseiller et bien organiser le post-partum tant physiquement
            qu’émotionnellement.
          </p>
          <Button>Contacte-nous</Button>
        </Card>
      ...
      <Section>
        <h2>QU’Y A T-IL DANS LE CURCUMENU ?</h2>
        <h3>Un engagement nutritionnel</h3>
        <StaticImage
      ...
      <h2>CURCUMAMAS : CRÉATRICES DE TRIBUS</h2>
      <p>
        L’équivalent en grec ancien de tribu est «faire naître, faire pousser».
        Nous proposons donc une cuisine ayurvédique, bio et locale à destination
        des parents qui naissent en même temps que leurs bébés et qui les font
        pousser. Pensés pour répondre au mieux aux besoins de jeunes mamans qui
        ont vécu le tsunami de la grossesse et de l’accouchement, nos petits
        plats se partagent très bien en famille et à n’importe quel moment de
        votre nouvelle vie de parents. Ils ont l’ambition de soutenir d’autres
        mamans en difficulté grâce aux livraisons suspendues, pour qu’à votre
        tour vous créiez une tribu.
      </p>
      <PetitPlusContainer>
        <Tribu>
          <StaticImage
        ...
        <Tribu>
          ...
          <p>
            ...
            premières leçons de jeunes parents : prendre soin de soi ! Commande
            nous un nombre de repas comprenant : entrée/plat/encas.
          </p>
        </Tribu>
        <Tribu>
          <StaticImage
          ...
          <p>
            Dans le prix de vente de chaque commande, 1€ est inclus pour offrir
            de bon petits plats à des mamans dans le besoin, par le biais
            d'associations toulousaines. Toi aussi crée une tribu grâce aux
